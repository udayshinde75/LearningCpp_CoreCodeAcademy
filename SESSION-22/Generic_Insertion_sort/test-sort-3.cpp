...
void test() 
{
    ...
    show_array<Date>(a_date, (s_size_t)(sizeof(a_date)/sizeof(a_date[0])), "Before sort:"); 
    insertion_sort<Date>(a_date, (s_size_t)(sizeof(a_date)/sizeof(a_date[0]))); 
    show_array<Date>(a_date, (s_size_t)(sizeof(a_date)/sizeof(a_date[0])), "Aftersort:"); 
}